package com.zbc.zsecret_realm.modItems.epicWeapon;
...
public class WorldDestructSwordItem extends SwordItem {

    public WorldDestructSwordItem(Tier p_43269_, int p_43270_, float p_43271_, Properties p_43272_) {
