package com.zbc.zsecret_realm.modItem.magicRing;
...
import static com.zbc.zsecret_realm.zcore.collect.LivingEntities.getNearbyLivingEntities;
import static com.zbc.zsecret_realm.zcore.livingEntity.doAction.addEffectToLivingEntity;
...
public class LightRingItem extends Item {
    ...
    // 默认声明方式
    public LightRingItem(Properties p_41383_) {
        super(p_41383_);
    }

    // 副标题声明方式
    public LightRingItem(Properties p_41383_, String subtitle) {
        super(p_41383_);
    ...
    private InteractionResultHolder<ItemStack> doAction(Level world, Player player, InteractionHand usedHand) {
        ...
        // 查找范围内的全部敌对生物并点亮
        List<LivingEntity> targets = getNearbyLivingEntities(world, player, 64);
        targets.forEach((entity) -> {
            addEffectToLivingEntity(entity, MobEffects.GLOWING, 20 * 60 * 5, 0);
        });
