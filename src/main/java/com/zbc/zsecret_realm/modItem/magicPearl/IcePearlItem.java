...
import com.zbc.zsecret_realm.modEntity.magicPearls.IcePearl;
...
public class IcePearlItem extends Item {

    public IcePearlItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41190_, Player p_41191_, InteractionHand p_41192_) {
        ...
        if (!p_41190_.isClientSide) {
            IcePearl pearl = new IcePearl(p_41190_, p_41191_);
            pearl.setItem($$3);
