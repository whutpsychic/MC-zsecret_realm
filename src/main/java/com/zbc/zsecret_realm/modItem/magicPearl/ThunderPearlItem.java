package com.zbc.zsecret_realm.modItem.magicPearl;

import com.zbc.zsecret_realm.modEntity.magicPearls.ThunderPearl;
...
public class ThunderPearlItem extends Item {

    public ThunderPearlItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41190_, Player p_41191_, InteractionHand p_41192_) {
        ...
        if (!p_41190_.isClientSide) {
            ThunderPearl pearl = new ThunderPearl(p_41190_, p_41191_);
            pearl.setItem($$3);
